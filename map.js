...
$(function () {
  ...
  mapboxgl.util.getJSON('https://www.mapbox.com/mapbox-gl-styles/styles/outdoors-v6.json', function (err, style) {
    ...
    $.getJSON('./data/processed/pools-per-capita.geojson', function (data, status, xhr) {
        ...
        zoom: 9
          ...
          map.featuresAt(e.point, {radius: 5}, function(err, features) {
              ...
              if (features.length > 0) {
                ...
                var str = "Area per capita (sq ft): " + round(feature.properties.area_per_capita * 10.7639, 2) + '\n' +
                          "features per capita: " + round(feature.properties.features_per_capita, 2);
